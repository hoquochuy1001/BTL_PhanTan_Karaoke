...
public class jdlAddPDP extends javax.swing.JDialog {
    ...
    private void btnChonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChonActionPerformed
    	LapHoaDon_GUI.SoGio =  Integer.parseInt(spnSoLuong.getValue().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdlAddPDP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
